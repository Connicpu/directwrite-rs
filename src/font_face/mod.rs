...
use winapi::um::dwrite::{DWRITE_FONT_METRICS, DWRITE_GLYPH_METRICS, DWRITE_GLYPH_OFFSET, DWRITE_MATRIX, IDWriteFontFace, IDWriteGeometrySink};
use wio::com::ComPtr;
...
impl FontFace {
    ...
    pub fn get_design_glyph_metrics(&self, glyph_indices: &[u16], is_sideways: bool) -> DWResult<Vec<DWRITE_GLYPH_METRICS>>{
        unsafe{
    ...
    pub fn get_gdi_compatible_glyph_metrics(&self, em_size: f32, pixels_per_dip: f32, transform: Option<&DWRITE_MATRIX>,
                                             use_gdi_natural: bool, glyph_indices: &[u16], is_sideways: bool) -> DWResult<Vec<DWRITE_GLYPH_METRICS>>{
        unsafe{
            let mut metrics = vec![mem::uninitialized(); glyph_indices.len()];
    ...
    pub fn get_gdi_compatible_metrics(&self, em_size: f32, pixels_per_dip: f32, transform: Option<&DWRITE_MATRIX>) -> DWResult<DWRITE_FONT_METRICS>{
        unsafe{
